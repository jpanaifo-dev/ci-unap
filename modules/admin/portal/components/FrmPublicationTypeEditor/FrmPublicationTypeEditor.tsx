...
import { postOrUpdPublicationType } from '@/api'

//To alert
import { toast } from 'react-toastify'

interface IProps {
  dataDeafult?: IPublicationType
}

export const FrmPublicationTypeEditor = (props: IProps) => {
  ...
  const methods = useForm<IPublicationType>({
  ...
  const handleFormSubmit: SubmitHandler<IPublicationType> = async (
    ...
    const errorMessage = dataDeafult?.id
      ...
      : 'Error al crear un nuevo tipo de publicación'

    const res = await postOrUpdPublicationType(data)
  ...
  const handleExit = () => {
    router.push('/admin/portal/tipo-contenido')
  }
                  ...
                  <Controller
                    ...
                    render={({ field: { value, onChange } }) => (
                      <Input
                        ...
                        placeholder="Escribir el nombre del tipo de publicación"
